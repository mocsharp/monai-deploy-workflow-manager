...
namespace Monai.Deploy.WorkloadManager.PayloadListener.Tests.Validators
{
    public class EventPayloadValidatorTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => { _eventPayloadValidator.ValidateWorkflowRequest(null); });
        }
        ...
        public void ValidateWorkflowRequest_WorkflowRequestMessageWithNullWorkflow_ThrowsArgumentNullException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => { _eventPayloadValidator.ValidateWorkflowRequest(message); });
        }
        ...
        private static InformaticsGateway GetInformaticsGateway(string aeiTitle)
        {
            return new InformaticsGateway
            {
                AeTitle = aeiTitle,
