...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Send task dispatch with artefact, recieve task update with same artefact")]
        [NUnit.Framework.CategoryAttribute("TaskArtefacts")]
        public virtual void SendTaskDispatchWithArtefactRecieveTaskUpdateWithSameArtefact()
        {
            string[] tagsOfScenario = new string[] {
                    "TaskArtefacts"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Send task dispatch with artefact, recieve task update with same artefact", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 50
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
#line 52
    testRunner.And("I have an artefact in the bucket dicom", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 53
    testRunner.When("I publish a task dispatch message Task-Dispatch-Event", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 54
    testRunner.Then("I recieve a task update message", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Send task dispatch without, recieve task update without artefact")]
        [NUnit.Framework.CategoryAttribute("TaskArtefacts")]
        public virtual void SendTaskDispatchWithoutRecieveTaskUpdateWithoutArtefact()
        {
            string[] tagsOfScenario = new string[] {
                    "TaskArtefacts"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Send task dispatch without, recieve task update without artefact", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 57
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
